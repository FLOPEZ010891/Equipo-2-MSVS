...
class TamizajeController extends Controller
{
    ...
    public function saveansiedad(Request $request)
    {
        $request->validateWithBag('customBag',[
            'r1' => 'required',
            'r2' => 'required',
        ...
        // Obtener respuestas del formulario
        $responses = $request->only(['r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9', 'r10', 'r11', 'r12', 'r13', 'r14', 'r15', 'r16', 'r17', 'r18', 'r19', 'r20', 'r21']);
        ...
        // Determinar el mensaje según la puntuación
        if ($puntuacion <= 5) {
            $mensaje = "Estimad@ " . auth()->user()->name . ", en relación con el puntaje obtenido en el Tamizaje, te informamos que los resultados corresponden a ansiedad mínima. Te sugerimos sigas cuidando de tu salud mental a través de las recomendaciones que te dejamos en esta página.";
        } elseif ($puntuacion > 5 && $puntuacion < 16) {
            $mensaje = "Estimad@ " . auth()->user()->name . ", en relación con el puntaje obtenido en la escala del Tamizaje, te informamos que los resultados sugieren una ansiedad leve. Te invimatos a que sigas cuidando de tu salud mental a través de las recomendaciones que te dejamos en esta página.";
        }elseif ($puntuacion > 15 && $puntuacion < 31) {
            $mensaje = "Estimad@ " . auth()->user()->name . ", en relación con el puntaje obtenido en la escala del Tamizaje, te informamos que los resultados sugieren una ansiedad moderada. Te invitamos a visitar tu unidad de salud más cercana a tu domicilio o puedes marcar a la línea de la vida al 800 911 2000 para recibir asesoría.";
